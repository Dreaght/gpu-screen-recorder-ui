...
namespace gsr {
    ...
    private:
        ...
        std::unique_ptr<Widget> create_video_quality();
        std::unique_ptr<Widget> create_video_resolution();
        ...
        std::unique_ptr<ComboBox> create_video_resolution_box();
    ...
    private:
        ...
        Widget *video_quality_ptr = nullptr;
        Widget *video_resolution_ptr = nullptr;
